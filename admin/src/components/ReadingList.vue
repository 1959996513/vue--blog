  ...
  <div style="height: 100%;">
    ...
    <div class="reading-list-container main">
      <transition name="slide-fade">
        <div class="dialog-container" v-show='isShow'  @click="hideDialog($event)">
          <section class="dialog">
            ...
            <section class="btn-container">
              ...
              <button id="cancel" class="delete" @click='giveUp'>取消</button>
            </section>
          </section>
        </div>
      </transition>
  ...
  export default {
    ...
    methods:{
      ...
      deleteBook:function(index){
        ...
        if (confirm(msg)==true){
           request({
             url:`/book/delete/${this.books[index].id}`,
             method:'delete'
           }).then(res=>{
      ...
      confirmChange:function () {
        ...
        if (name && author) {
          request({
            ...
            // console.log(res);
            this.books.splice(this.editingIndex, 1, {name, author, score})
              this.isShow = false
            })
            .catch(err =>{
              console.log(err)
